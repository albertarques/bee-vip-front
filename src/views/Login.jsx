  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      Swal.fire({
        position: "center",
        icon: "success",
        title: `Hola ${(data.user.username).charAt(0).toUpperCase() + (data.user.username).slice(0 + 1)}, has iniciado sesión con éxito!`,
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <a
                  href="#"
                  className="text-sm ml-2 font-medium text-primary-600 hover:underline dark:text-blue-500"
                >
